...
public class CharacterInfo implements Serializable{
	...
	private String  	chaForward 	= "down";		// up down left right 캐릭터가 보는 방향
	private String[] 	chaForwardImg;
	
	private int 		speed;					// 캐릭터 속도 [클래스에 따라 다름]
	
	private int			width	= new ImageIcon("image/fighterDown.png").getImage().getWidth(null);	// 가로 캐릭터의 크기
	private int			height	= new ImageIcon("image/fighterDown.png").getImage().getHeight(null);	// 세로 캐릭터의 크기
